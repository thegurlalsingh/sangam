...
const Contact = () => {
  return (
    <section className="w-full min-h-screen bg-[#F9E9D6] text-[#A03232] pb-20 px-6 sm:px-10 lg:px-16">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="rounded-2xl overflow-hidden shadow-2xl shadow-[#A03232]/30 border border-[#A03232]/20 mt-12">
